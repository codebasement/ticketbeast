...
class AddConcertTest extends TestCase
{
    ...
    function guests_cannot_add_new_concerts()
    {
        $response = $this->post('/backstage/concerts', [
        	'title' => 'No Guests Adding New Concerts',
        	'subtitle' => 'with Cruel Hand and Backtrack',
        	'additional_information' => "You must be must be a promoter to add a new concert.",
        	'date' => '2017-11-18',
        	'time' => '8:00pm',
        	'venue' => 'The Mosh Pit',
        	'venue_address' => '123 Fake St',
    ...
    function title_is_required()
    {
        ...
        $response = $this->actingAs($user)->from('/backstage/concerts/new')->post('/backstage/concerts', [
        	'title' => '',
        	'subtitle' => 'with Cruel Hand and Backtrack but no Title',
        	'additional_information' => "You must have a tile",
        	'date' => '2017-11-18',
        	'time' => '8:00pm',
        	'venue' => 'The Mosh Pit',
        	'venue_address' => '123 Fake St',
